...
export const BlackBox = () => {
  return (
    <div className='layout relative flex min-h-screen flex-col items-center justify-center py-12 text-center'>
       ...
       */}
      <div className='bg-fg text-bg px-6 py-9 flex flex-col gap-9 max-w-[456px] sm:flex-row sm:items-start sm:max-w-[9000px] sm:bg-green-900 md:bg-slate-800 lg:bg-black'>
        {/* Magic box */}
